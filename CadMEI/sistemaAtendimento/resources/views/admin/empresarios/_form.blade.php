<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group {{ $errors->has('titulo_eleitor') ? 'has-error' : '' }}">
            <label for="TituloEleitor" class="control-label">Título Eleitor</label>
            <input for="TituloEleitor" class="form-control eleitor" type="text" name="titulo_eleitor" value="{{ isset($registro->titulo_eleitor) ? $registro->titulo_eleitor : old('titulo_eleitor') }}" />
            @if($errors->has('titulo_eleitor'))
                <small for="TituloEleitor" class="control-label">{{ $errors->first('titulo_eleitor') }}</small>
            @endif
        </div>
        <div class="form-group {{ $errors->has('nascimento') ? 'has-error' : '' }}">
            <label for="Nasc" class="control-label">Data de Nascimento</label>
            <input for="Nasc" class="form-control data" type="text" name="nascimento" value="{{ isset($registro->nascimento) ? date('d-m-Y', strtotime($registro->nascimento)) : old('nascimento') }}" />
            @if($errors->has('nascimento'))
                <small for="Nasc" class="control-label">{{ $errors->first('nascimento') }}</small>
            @endif
        </div>
