...
<div class="box">
    ...
    <div class="box-body">
        <form action="{{ route('admin.empresas.salvar') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Confirmar cadastro da empresa?</p>
                        </div>
...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('admin.empresas') }}"><i class="fa fa-arrow-circle-left fa-lg"></i>  Retornar para listagem</a>
    </div>
</div>
